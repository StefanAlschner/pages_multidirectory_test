...
(function () {
  d3.timeline = function () {
    ...
    var appendTimeAxisTick = function (g, xAxis, maxStack) {
      g.append("g")
        .attr("class", "axis series-container")
        .attr("data-height", margin.top + (itemHeight + itemMargin) * maxStack) // Clausen
    ...
    var appendLabel = function (gParent, yAxisMapping, index, hasLabel, datum) {
      ...
      gParent.append("g").append("text")
        .attr("class", "timeline-label")
        .attr("data-type", function (d, i) {   // Clausen: data-type
          return (datum.label);
        })
    ...
    function timeline(gParent) {
      ...
      g.each(function (d, i) {
        ...
        d.forEach(function (datum, index) {
          ...
          // Clausen: append default (golden) rect
          ...
          g.selectAll("svg").data(data).enter()
            ...
            .attr("cx", getXPos)
            .attr("r", itemHeight / 2)
            .attr("data-number", function (d, i) { // Clausen: data-number
              return (d.number);
            })
            .attr("data-type", function (d, i) { // Clausen: data-type
              return (datum.label);
            ...
            .attr("class", function (d, i) {
              return datum.class ? "timelineSeries dynamic timelineSeries_" + datum.class: "timelineSeries dynamic timelineSeries_" + index;
